        ...
        <div className="flex-1 flex items-center justify-center px-4 py-12">
          <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Your hospital registration has been submitted successfully. A Super Admin will review your application and approve it soon.
            </p>
      ...
      <div className="flex-1 px-4 py-12">
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-6">
              Join our blood donation network. After registration, a Super Admin will review and approve your hospital.
            </p>
